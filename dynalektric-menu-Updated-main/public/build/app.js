...
`;
  ...
  function PageRnd({ navigate }) {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "custom-eng-copy" }, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--accent)" } }, "Custom engineering"), /* @__PURE__ */ React.createElement("h2", { style: { marginTop: 16 } }, "Have a non-standard requirement?"), /* @__PURE__ */ React.createElement("p", { className: "lead", style: { marginTop: 24 } }, "Our engineering team supports customer-specific requirements with technical review, product customization and manufacturing support for industrial, railway and power applications."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, marginTop: 32, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: () => navigate("contact") }, "Submit RFQ ", /* @__PURE__ */ React.createElement("span", { className: "arrow" }, "\u2192")), /* @__PURE__ */ React.createElement("button", { className: "btn btn-secondary", onClick: () => navigate("products") }, "Browse products")))))), /* @__PURE__ */ React.createElement(Footer, { navigate }));
  }
