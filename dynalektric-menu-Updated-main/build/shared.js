(() => {
    ...
    "src/data/products.js"() {
      ...
      SUBCAT_DETAIL = {
        ...
        "04.8": {
          ...
          specs: [
            { k: "Input voltage", v: "240 VAC \xB110%" },
  ...
  var CERTIFICATIONS, STATS, HERO_HEADLINES, QUALIFICATION;
  var init_certifications = __esm({
    "src/data/certifications.js"() {
      CERTIFICATIONS = [
      ...
      HERO_HEADLINES = [
        {
          pre: "Manufacturing partner \xB7 India \xB7 ISO 9001",
  ...
  function Counter({ to, suffix = "", duration = 1400 }) {
    ...
    return /* @__PURE__ */ React.createElement("span", { ref, className: "mono-num" }, val, suffix);
  }
  var Counter_default;
  ...
  // src/components/common/EngineeringVisual.jsx
  function EngineeringVisual({ variant = "grid" }) {
    return /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 600 660", className: "eng-svg", preserveAspectRatio: "xMidYMid meet", style: { width: "100%", height: "100%", display: "block" } }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("pattern", { id: "dynaGrid", x: "0", y: "0", width: "20", height: "20", patternUnits: "userSpaceOnUse" }, /* @__PURE__ */ React.createElement("path", { d: "M 20 0 L 0 0 0 20", fill: "none", stroke: "rgba(14,17,22,0.06)", strokeWidth: "1" })), /* @__PURE__ */ React.createElement("pattern", { id: "dynaGridMajor", x: "0", y: "0", width: "100", height: "100", patternUnits: "userSpaceOnUse" }, /* @__PURE__ */ React.createElement("path", { d: "M 100 0 L 0 0 0 100", fill: "none", stroke: "rgba(14,17,22,0.12)", strokeWidth: "1" }))), /* @__PURE__ */ React.createElement("rect", { width: "600", height: "660", fill: "var(--bg-card)" }), /* @__PURE__ */ React.createElement("rect", { width: "600", height: "660", fill: "url(#dynaGrid)" }), /* @__PURE__ */ React.createElement("rect", { width: "600", height: "660", fill: "url(#dynaGridMajor)" }), /* @__PURE__ */ React.createElement("g", { transform: "translate(300 330)", fill: "none", stroke: "var(--ink)", strokeWidth: "1" }, /* @__PURE__ */ React.createElement("circle", { r: "40" }), /* @__PURE__ */ React.createElement("circle", { r: "80" }), /* @__PURE__ */ React.createElement("circle", { r: "120", strokeOpacity: "0.7" }), /* @__PURE__ */ React.createElement("circle", { r: "160", strokeOpacity: "0.5" }), /* @__PURE__ */ React.createElement("circle", { r: "200", strokeOpacity: "0.3" }), /* @__PURE__ */ React.createElement("circle", { r: "240", strokeOpacity: "0.15" })), /* @__PURE__ */ React.createElement("g", { stroke: "var(--accent)", strokeWidth: "1.5", fill: "none" }, /* @__PURE__ */ React.createElement("path", { d: "M 60 330 L 180 330" }), /* @__PURE__ */ React.createElement("path", { d: "M 420 330 L 540 330" }), /* @__PURE__ */ React.createElement("circle", { cx: "180", cy: "330", r: "3", fill: "var(--accent)" }), /* @__PURE__ */ React.createElement("circle", { cx: "420", cy: "330", r: "3", fill: "var(--accent)" })), /* @__PURE__ */ React.createElement(
      "path",
      {
        d: "M 60 540 Q 105 500 150 540 T 240 540 T 330 540 T 420 540 T 510 540 T 540 540",
        fill: "none",
        stroke: "var(--accent-2)",
        strokeWidth: "1.5"
      }
    ), /* @__PURE__ */ React.createElement("g", { stroke: "var(--ink)", strokeWidth: "1" }, /* @__PURE__ */ React.createElement("line", { x1: "60", y1: "60", x2: "60", y2: "80" }), /* @__PURE__ */ React.createElement("line", { x1: "60", y1: "60", x2: "80", y2: "60" }), /* @__PURE__ */ React.createElement("line", { x1: "540", y1: "60", x2: "540", y2: "80" }), /* @__PURE__ */ React.createElement("line", { x1: "540", y1: "60", x2: "520", y2: "60" }), /* @__PURE__ */ React.createElement("line", { x1: "60", y1: "600", x2: "60", y2: "580" }), /* @__PURE__ */ React.createElement("line", { x1: "60", y1: "600", x2: "80", y2: "600" }), /* @__PURE__ */ React.createElement("line", { x1: "540", y1: "600", x2: "540", y2: "580" }), /* @__PURE__ */ React.createElement("line", { x1: "540", y1: "600", x2: "520", y2: "600" })), /* @__PURE__ */ React.createElement("g", { fontFamily: "JetBrains Mono, monospace", fontSize: "10", fill: "var(--ink-muted)", letterSpacing: "1" }, /* @__PURE__ */ React.createElement("text", { x: "60", y: "50" }, "FIG. 01 / CORE TOPOLOGY"), /* @__PURE__ */ React.createElement("text", { x: "60", y: "640" }, "f = 50 / 60 Hz"), /* @__PURE__ */ React.createElement("text", { x: "540", y: "640", textAnchor: "end" }, "DYN-01.A")));
  }
  var EngineeringVisual_default;
  var init_EngineeringVisual = __esm({
    "src/components/common/EngineeringVisual.jsx"() {
      EngineeringVisual_default = EngineeringVisual;
    }
  });

  // src/components/common/CaseStudyGrid.jsx
  function CaseStudyGrid({ items = CASE_STUDIES, limit }) {
    const data = limit ? items.slice(0, limit) : items;
    return /* @__PURE__ */ React.createElement("div", { className: "case-grid" }, data.map((c, i) => /* @__PURE__ */ React.createElement("article", { className: "case-card", key: i }, /* @__PURE__ */ React.createElement("div", { className: "case-tag" }, c.tag), /* @__PURE__ */ React.createElement("h3", null, c.title), /* @__PURE__ */ React.createElement("div", { className: "case-section" }, /* @__PURE__ */ React.createElement("div", { className: "case-label" }, "Product group"), /* @__PURE__ */ React.createElement("div", { className: "case-value" }, c.productGroup)), /* @__PURE__ */ React.createElement("div", { className: "case-section" }, /* @__PURE__ */ React.createElement("div", { className: "case-label" }, "Buyer need"), /* @__PURE__ */ React.createElement("div", { className: "case-value" }, c.buyerNeed)), /* @__PURE__ */ React.createElement("div", { className: "case-section" }, /* @__PURE__ */ React.createElement("div", { className: "case-label" }, "Quality or documentation consideration"), /* @__PURE__ */ React.createElement("div", { className: "case-value" }, c.quality)))));
  }
  var CaseStudyGrid_default;
  var init_CaseStudyGrid = __esm({
    "src/components/common/CaseStudyGrid.jsx"() {
      CaseStudyGrid_default = CaseStudyGrid;
    }
  });

  // src/components/common/FinalCTA.jsx
  function FinalCTA({
    navigate,
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "section reveal", style: { paddingTop: "calc(var(--section-y) * 1.2)", paddingBottom: "calc(var(--section-y) * 1.2)" } }, /* @__PURE__ */ React.createElement("div", { className: "container", style: { textAlign: "center", maxWidth: 880, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { marginBottom: 24, color: "var(--accent)" } }, eyebrow), /* @__PURE__ */ React.createElement("h2", { style: { marginBottom: 32 } }, heading), /* @__PURE__ */ React.createElement("p", { className: "lead", style: { margin: "0 auto 40px", textAlign: "center" } }, body), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: () => navigate(primaryTo) }, primaryLabel, " ", /* @__PURE__ */ React.createElement("span", { className: "arrow" }, "\u2192")), /* @__PURE__ */ React.createElement("button", { className: "btn btn-secondary", onClick: () => navigate(secondaryTo) }, secondaryLabel)), tertiaryLabel && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 24 } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        className: "mono",
  ...
  var FinalCTA_default;
  var init_FinalCTA = __esm({
    "src/components/common/FinalCTA.jsx"() {
      FinalCTA_default = FinalCTA;
    }
  });
  ...
  function Footer() {
    ...
    return /* @__PURE__ */ React.createElement("footer", { className: "footer" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { className: "footer-grid" }, /* @__PURE__ */ React.createElement("div", { className: "footer-col" }, /* @__PURE__ */ React.createElement(
      "img",
      {
        className: "footer-logo",
        src: window.__resources && window.__resources.dynaLogoReversed || "assets/Dynalektric-logo-reversed2.png",
    ...
    ), /* @__PURE__ */ React.createElement("p", { className: "footer-tag" }, "Magnetics, control panel assemblies, power electronics and cross segment solutions."), /* @__PURE__ */ React.createElement("div", { className: "footer-duns-seal" }, /* @__PURE__ */ React.createElement(
      "iframe",
      {
        id: "Iframe1",
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "footer-col" }, /* @__PURE__ */ React.createElement("h4", null, "Sitemap"), /* @__PURE__ */ React.createElement("nav", { "aria-label": "Footer navigation" }, /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "/" }, "Home")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "about" }, "About")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "products-solutions" }, "Products & Solutions")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "innovation-rd" }, "Innovation Portfolio")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "industries-applications" }, "Industries & Applications")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "export" }, "Export")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "contact" }, "Contact"))))), /* @__PURE__ */ React.createElement("div", { className: "footer-col" }, /* @__PURE__ */ React.createElement("h4", null, "Product groups"), /* @__PURE__ */ React.createElement("ul", null, PRODUCTS.map((p) => /* @__PURE__ */ React.createElement("li", { key: p.id }, /* @__PURE__ */ React.createElement("a", { href: `products-solutions?focus=${p.id}` }, p.name))))), /* @__PURE__ */ React.createElement("div", { className: "footer-col" }, /* @__PURE__ */ React.createElement("h4", null, "Enquiries"), /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "tel:+919035542821" }, "+91-903 554 2821")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "tel:+919035542827" }, "+91-903 554 2827")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "mailto:sales01@dynalektric.com" }, "sales01@dynalektric.com")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "mailto:cs@dynalektric.com" }, "cs@dynalektric.com")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "contact" }, "Submit RFQ \u2192"))))), /* @__PURE__ */ React.createElement("div", { className: "footer-bottom" }, /* @__PURE__ */ React.createElement("span", null, "\xA9 ", currentYear, " Dynalektric \xB7 Power \xB7 Motion \xB7 Safety"), /* @__PURE__ */ React.createElement("span", { style: { textTransform: "none", fontSize: "12px" } }, "Designed by", " ", /* @__PURE__ */ React.createElement(
      "a",
      {
      ...
      "InnooRyze"
    )), /* @__PURE__ */ React.createElement("span", null, "Engineered in India \xB7 Exported worldwide"))));
  }
  var Footer_default;
  ...
  // src/components/common/shared.jsx
  var require_shared = __commonJS({
    "src/components/common/shared.jsx"() {
      ...
      Object.assign(window, {
        ...
        EngineeringVisual: EngineeringVisual_default,
        Footer: Footer_default,
        FinalCTA: FinalCTA_default,
        CaseStudyGrid: CaseStudyGrid_default
      });
    }
  });
  require_shared();
