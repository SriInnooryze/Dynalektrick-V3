...
function CertBadgeLabel({ status, isMobile }) {
  if (status === "available") return isMobile ? "Available on req." : /* @__PURE__ */ React.createElement(React.Fragment, null, "Available based on", /* @__PURE__ */ React.createElement("br", null), "requirement");
