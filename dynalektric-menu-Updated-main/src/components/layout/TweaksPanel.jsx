...
function TweaksPanel({ title = 'Tweaks', children }) {
  ...
  return (
    <div className="twk-panel" role="region" aria-label={title}>
      <div className="twk-hd">
        <b>{title}</b>
        <button className="twk-x" onClick={handleClose} title="Close tweaks">×</button>
      </div>
...
function TweakRadio({ label, value, options, onChange }) {
  ...
  return (
    <TweakRow label={label}>
      <div className="twk-seg" ref={containerRef}>
...
export { TweakSection, TweakRow, TweakSlider, TweakToggle, TweakRadio, TweakSelect, TweakText, TweakNumber, TweakColor, TweakButton };
