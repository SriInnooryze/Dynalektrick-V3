...
function PageContact({ navigate, focusId }) {
  ...
  const submit = async (e) => {
    ...
    // Show the success screen right away; the actual write to Apps Script
    // (Sheets/email) is slow and happens in the background so the user
    // isn't stuck waiting on it.
    setIsSubmitting(false);
    setSubmitted(true);
              ...
              <div className="success-summary">
                ...
                {leadId && (
                  <div className="success-row">
                    <span className="mono">RFQ Reference</span>
                    <span><strong>{leadId}</strong></span>
                  </div>
                )}
